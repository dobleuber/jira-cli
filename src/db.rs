...
impl JiraDatabase {
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        let epic = db_state
            .epics
            .get_mut(&epic_id)
            .ok_or_else(|| anyhow!("The epic {epic_id} doesn't exist!"))?;
    ...
    pub fn delete_epic(&self, epic_id: u32) -> Result<()> {
        ...
        let epic = db_state
            ...
            .get(&epic_id)
            .ok_or_else(|| anyhow!("The epic {epic_id} doesn't exist!"))?;
        epic.stories.iter().for_each(|s_id| {
            db_state.stories.remove(s_id);
        });
    ...
    pub fn delete_story(&self, epic_id: u32, story_id: u32) -> Result<()> {
        ...
        db_state
            .stories
            .remove(&story_id)
            .ok_or_else(|| anyhow!("The story {story_id} doesn't exist!"))?;
        let epic = db_state
            .epics
            .get_mut(&epic_id)
            .ok_or_else(|| anyhow!("The epic {epic_id} doesn't!"))?;
        epic.stories.retain(|&s| s != story_id);
        self.database.write_db(&db_state)?;
        Ok(())
    }
